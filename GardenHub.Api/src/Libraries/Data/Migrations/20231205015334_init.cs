        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GardenerId = table.Column<long>(type: "bigint", nullable: true),
                    RecordStatus = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "DateTime", nullable: false, defaultValueSql: "GetUtcDate()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GardenerProfileWorkType", x => new { x.GardenersId, x.WorkTypesId });
                    table.ForeignKey(
                        name: "FK_GardenerProfileWorkType_GardenerProfiles_GardenersId",
                        column: x => x.GardenersId,
                        principalTable: "GardenerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
